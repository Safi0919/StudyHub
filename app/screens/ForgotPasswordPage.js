...
function ForgotPasswordPage(props) { 
    const navigateToResetPasswordPage = () => {
        props.navigation.navigate('ResetPasswordPage'); 
    }
    return (
        <View style={styles.container}>
            ...
            <TextInput
                style={styles.input}
                placeholderTextColor="gray"
                placeholder="Enter the code sent via email"
                secureTextEntry={true}                  
            />                                                                          
            <TouchableOpacity style={styles.button} onPress={navigateToResetPasswordPage}>      
